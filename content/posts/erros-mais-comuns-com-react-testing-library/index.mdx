...
**Conselho: put side-effects outside `waitFor` callbacks and reserve the callback for assertions only.**
...
**Conselho: If you want to assert that something exists, make that assertion explicit.**
