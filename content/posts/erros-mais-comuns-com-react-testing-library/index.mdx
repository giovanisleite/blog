...
**Conselho: Learn when `act` is necessary and don't wrap things in `act`
unnecessarily.**
...
provide you with help you do this, but not all queries are created equally.
...
**Conselho: Read and follow the recommendations on
[The "Which Query Should I Use" Guide](https://testing-library.com/docs/guide-which-query).**
...
**Conselho: Avoid adding unnecessary or incorrect accessibility attributes.**
