...
margin-block-start, margin-inline-start e margin-block-end, são alguns exemplos dos operadores chamados [operadores lógicos](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties), por conta dessa variação de direções, eles são úteis. Esses margins, há também paddings e borders, atuam de acordo com o writing-mode. Se o idioma é da direita para a esquerda, o margin-inline-start será a direita e vice-versa. Diferente dos operador margin-left, por exemplo, que sempre será a esquerda.
